            ...
            <div class="col-md-4">
                <div class="card card-custom">
                    <div class="card-body">
                        ...
                        <p class="card-text">View All Items</p>
                        <a href="all_item.php" class="btn btn-primary">View All Items</a>       
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card card-custom">
                    <div class="card-body">
                        <h5 class="card-title">Currently Borrowed Items</h5>
                        <p class="card-text">View Currently Borrowed Items</p>
                        <a href="currently_borrowed_items.php" class="btn btn-primary">Previously Borrowed Items</a>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card card-custom">
                    <div class="card-body">
                        <h5 class="card-title">Returned Borrowed Items</h5>
                        <p class="card-text">View Returned Borrowed Items</p>
                        <a href="returned_item.php" class="btn btn-primary">Returned Borrowed Items</a>
                    </div>
                </div>
            </div>
        </div>
